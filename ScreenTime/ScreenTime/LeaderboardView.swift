                    ...
                    ZStack {
                        VStack {
                            ...
                            .sheet(isPresented: $showingShareSheet) {
                                ShareSheet(items: [
                                    "Join me on Pawse and compete on the leaderboard! Download the app here: https://pawseapp.com/invite"
                                ])
                            }
...
struct ShareSheet: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: Context) -> UIActivityViewController {
        ...
        // Don't exclude any activities - allow all sharing options
        // This enables Messages, Instagram, Snapchat, AirDrop, Mail, WhatsApp, etc.
